...
namespace pairhmm {
std::vector<std::vector<double>> standard_gop_vector = {
...
table::STRTable<double> standard_gop =
    transform_into_STRTable(standard_gop_vector);

std::vector<std::vector<double>> standard_gcp_vector = {
...
table::STRTable<double> standard_gcp =
